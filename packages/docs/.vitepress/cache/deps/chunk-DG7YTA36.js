...
// ../../node_modules/.pnpm/wordgard@0.3.1/node_modules/wordgard/dist/editor.js
...
var Decoration = function(Decoration2) {
  (function(Tag) {
    function shape(type, shape2, config) {
      ...
      let atom = typeof shape2 == "function" ? config == null ? void 0 : config.atom : !shape2.hasContent;
    ...
    (function(shape_1) {
      function dynamic(type, shape2, config) {
        ...
        let atom = config == null ? void 0 : config.atom;
        if (tp.isPlot && atom != null)
          ext = [ext, GardState.isAtom.of([tp, atom])];
        return ext;
      }
    ...
    function attribute(type, attr, value, options) {
      ...
      return tagAttribute.of({
        ...
        target: (options == null ? void 0 : options.target) ? Elt.Selector.parse(options.target) : null
      });
    }
  ...
  class Point {
    ...
    static widget(widget, options) {
      return new WidgetDecoration(widget, (options == null ? void 0 : options.side) || 0, options && "trackMode" in options ? options.trackMode : "around");
    }
    static attributes(attrs, options) {
      return new AttributeDecoration(Attributes.read(attrs), (options == null ? void 0 : options.target) ? Elt.Selector.parse(options.target) : null);
    }
    static shape(shape) {
    ...
    static wrapper(wrapper, spec) {
      ...
      return new WrapperDecoration(wrapper, (spec == null ? void 0 : spec.target) ? Elt.Selector.parse(spec.target) : null);
    }
  }
  __publicField(Point, "source", GardState.Facet.define({
  ...
  __publicField(Range, "source", GardState.Facet.define());
  Decoration2.Range = Range;
  ;
  return Decoration2;
}({});
var tagShape = GardState.Facet.define();
var tagWrapper = GardState.Facet.define();
var tagWidget = GardState.Facet.define();
var tagAttribute = GardState.Facet.define();
function memo(f) {
...
var nodeSelectionDeco = Decoration.Point.attributes({ class: "wg-selected-node" });
...
__publicField(_PointSet, "empty", (() => new _PointSet(none, none))());
...
__publicField(_RangeSet, "empty", (() => new _RangeSet(none, none, none))());
    ...
    if (ins == -1 && globalChange) {
      ...
      compareDecoSet(prevDeco.points, deco.points, (a, b) => {
        (a || PointSet.empty).compareRange(posA, b || PointSet.empty, posB, len, (pos2, val) => {
          add(pos2, Math.min(pos2 + (val instanceof WidgetDecoration ? 0 : 1), endB));
...
var HeapIterator = class {
  constructor(rangeHeap, pointHeap, start, end) {
    __publicField(this, "rangeHeap");
    __publicField(this, "pointHeap");
...
var renderMarkWrapper = memo((mark) => {
...
var DecoIterator = class {
  constructor(state, decoSet) {
    ...
    __publicField(this, "decoSet");
    __publicField(this, "tagShapes");
    __publicField(this, "globalWidgets");
    __publicField(this, "globalWrappers");
    __publicField(this, "globalAttrs");
    __publicField(this, "schema");
    __publicField(this, "pos");
    __publicField(this, "rangeIter", []);
    __publicField(this, "pointIter", []);
    this.state = state;
...
var exceptionSink = GardState.Facet.define();
  ...
  for (let cur = dom, stop = false; cur && !stop; ) {
    if (cur.nodeType == 1) {
      ...
      if (top2) {
        ...
        bounding = new DOMRect(rect2.left, rect2.top, cur.clientWidth * scaleX, cur.clientHeight * scaleY);
      }
      let moveX = 0, moveY = 0;
      if (y == "nearest") {
...
var DOMSelectionState = class {
  constructor() {
    __publicField(this, "anchorNode", null);
    __publicField(this, "anchorOffset", 0);
    __publicField(this, "focusNode", null);
    __publicField(this, "focusOffset", 0);
  }
  eq(domSel) {
...
var CoordPos = class _CoordPos {
  constructor(pos, target, side, vertOutside) {
    ...
    __publicField(this, "side");
    __publicField(this, "vertOutside");
    this.pos = pos;
    this.target = target;
    this.side = side;
...
var CompositeTile = class extends Tile {
  ...
  posAtCoordsInner(start, state, x, y, textblock, orientation) {
    ...
    let target = this.node && this.node.type.isSelectable && x >= rect.left && x <= rect.right && y >= rect.top && y <= rect.bottom ? start : null;
...
var DocTile = class _DocTile extends CompositeTile {
  constructor(state, dom, cursorWrapper, decoSet) {
    super(dom, 2);
    __publicField(this, "state");
    __publicField(this, "cursorWrapper");
    __publicField(this, "decoSet");
    this.state = state;
  ...
  updateRanges(state, decoSet, sections, connected, composition) {
    let wrapper = (composition == null ? void 0 : composition.wrapCursor) || null;
...
var WidgetTile = class extends Tile {
  ...
  connect() {
    var _a, _b;
    (_b = (_a = this.widget.type).connect) == null ? void 0 : _b.call(_a, this.widget.value, this.dom);
  }
  disconnect(reused) {
    var _a, _b;
    if (!reused || reused.get(this) != 1)
      (_b = (_a = this.widget.type).disconnect) == null ? void 0 : _b.call(_a, this.widget.value, this.dom);
  }
  toString() {
  ...
  posAtCoordsInner(start, state, x, y, textblock, orientation) {
    ...
    let rect = this.dom.nodeType == 1 ? this.dom.getBoundingClientRect() : textRange(this.dom, 0, this.length).getBoundingClientRect();
    let after = orientation == 1 ? y > (rect.top + rect.bottom) / 2 : x < (rect.left + rect.right) / 2 == ltrAt(state, start, 1, textblock);
  ...
  posAtCoordsInner(start, state, x, y, textblock, orientation) {
    let { closest, rect } = rowScan(x, y, (add) => {
      for (let i = 0; i < this.length; ) {
        ...
        let rect2 = singleRect(textRange(this.dom, i, end), 1, true);
...
var ContentUpdate = class {
  constructor(state, old, deco, cursorWrapper) {
    ...
    __publicField(this, "old");
    __publicField(this, "new");
    __publicField(this, "posB", 0);
    __publicField(this, "reused", /* @__PURE__ */ new Map());
    __publicField(this, "keepWalker");
    __publicField(this, "toConnect", []);
    __publicField(this, "partialNode", null);
    this.state = state;
    this.deco = deco;
...
var brHack = Widget.create({
  render() {
    return document.createElement("br");
  }
});
var imgHack = Widget.create({
  render() {
...
function flattenH(rect, top2) {
  return rect.height ? new DOMRect(rect.left, top2 ? rect.top : rect.bottom, rect.width, 0) : rect;
}
var nav = typeof navigator != "undefined" ? navigator : { userAgent: "", vendor: "", platform: "" };
var doc = typeof document != "undefined" ? document : { documentElement: { style: {} } };
var edge = (() => /Edge\/(\d+)/.exec(nav.userAgent))();
var gecko = (() => !edge && /gecko\/(\d+)/i.test(nav.userAgent))();
var chrome = (() => !edge && /Chrome\/(\d+)/.exec(nav.userAgent))();
var webkit = (() => "webkitFontSmoothing" in doc.documentElement.style)();
var safari = (() => !edge && /Apple Computer/.test(nav.vendor))();
...
var clipboardOutputFilter = GardState.Facet.define();
var clipboardOutputHTMLFilter = GardState.Facet.define();
var clipboardTextSerializer = GardState.Facet.define();
var clipboardOutputTextFilter = GardState.Facet.define();
var clipboardInputFilter = GardState.Facet.define();
var clipboardInputHTMLFilter = GardState.Facet.define();
var clipboardTextParser = GardState.Facet.define();
var clipboardInputTextFilter = GardState.Facet.define();
...
var theme$1 = GardState.Facet.define({ combine: (strs) => strs.join(" ") });
var colorScheme = GardState.Facet.define({
  combine: (values) => values.length ? values[0] : "light"
});
var styleID = StyleModule.newName();
...
var baseStyles = buildTheme("." + styleID, {
  "&": {
    ...
    if ((forward ? index == parent.node.content.length : !index) || parent.node.type.orientation == "row" && !entering) {
      ...
      if (!next.inlineContent && next.type.orientation == "row") {
        ...
        for (let chPos = nextPos + 1, i = 0; i < next.content.length; i++) {
          ...
          let dist2 = x < rect.left ? rect.left - x : x > rect.right ? x - rect.right : 0;
...
var DOMObserver = class {
  constructor(wg) {
    ...
    __publicField(this, "selectionRange", new DOMSelectionState());
    __publicField(this, "selectionChanged", false);
    __publicField(this, "resizeTimeout", -1);
    __publicField(this, "queue", []);
    __publicField(this, "dirty", null);
    __publicField(this, "scrollTargets", []);
    __publicField(this, "resizeScroll", null);
    __publicField(this, "darkThemeQuery", null);
    this.wg = wg;
  ...
  connect() {
    ...
    (_a = this.resizeScroll) == null ? void 0 : _a.observe(this.dom);
  ...
  disconnect() {
    ...
    (_a = this.resizeScroll) == null ? void 0 : _a.disconnect();
...
KeyBinding = function(KeyBinding2) {
...
var eventHandler = GardState.Facet.define({
  combine: (handlers) => {
...
var eventObserver = GardState.Facet.define({
  combine: (observers) => {
    let result = /* @__PURE__ */ Object.create(null);
...
var InputState = class {
  constructor(wg) {
    ...
    __publicField(this, "lastKeyCode", 0);
    __publicField(this, "lastKeyTime", 0);
    __publicField(this, "lastTouchTime", 0);
    __publicField(this, "lastScrollTop", 0);
    __publicField(this, "lastScrollLeft", 0);
    __publicField(this, "lastContextMenu", 0);
    __publicField(this, "scrollHandlers", []);
    __publicField(this, "handlers", /* @__PURE__ */ Object.create(null));
    __publicField(this, "composing", null);
    __publicField(this, "compositionEndedAt", 0);
    __publicField(this, "compositionPendingKey", false);
    __publicField(this, "pendingComposition", null);
    __publicField(this, "pendingDeletion", null);
    __publicField(this, "modifiedTextNodes", /* @__PURE__ */ new Set());
    __publicField(this, "wrappingComposition", null);
    __publicField(this, "mouseSelection", null);
    __publicField(this, "draggedContent", null);
    __publicField(this, "notifiedFocused");
    this.wg = wg;
...
var mouseSelectionStyle = GardState.Facet.define();
...
var dragBehavior = GardState.Facet.define();
...
var dropHandler = GardState.Facet.define();
var pasteHandler = GardState.Facet.define();
...
var isFocusChange = Transaction.Annotation.define();
...
function compositionUpdate(wg, event) {
  ...
  if (!wg.inputState.composing) {
    ...
    if (!wg.inputState.composing.changes && !event.data) {
      ...
      if (sel.empty && (sel instanceof GardSelection.Text && sel.marks || !rSel.head.inText && rSel.head.index) && !eqArray((_a = rSel.head.nodeBefore) == null ? void 0 : _a.tag.marks, rSel.activeMarks))
...
function interpretDOMPosition(wg, node, offset, bias) {
  if (node.nodeType == 3 && wg.viewState.pending.length && wg.inputState.modifiedTextNodes.has(node)) {
    ...
    if ((parent == null ? void 0 : parent.isText) && parent.dom == node) {
...
var baseHandlers = {
  ...
  beforeinput(wg, event) {
    ...
    if (type == "insertText") {
      ...
      let slice = (_a = readClipboard(wg.state, event.dataTransfer, wg.state.sel.head, true)) == null ? void 0 : _a.slice;
      if (slice) {
...
var scrollIntoView = Transaction.Effect.define({ map: (t, ch) => t.map(ch) });
...
var ViewState = class {
  constructor(state) {
    ...
    __publicField(this, "contentDOMWidth", 0);
    __publicField(this, "contentDOMHeight", 0);
    __publicField(this, "editorHeight", 0);
    __publicField(this, "editorOffset", 0);
    __publicField(this, "editorWidth", 0);
    __publicField(this, "scrollTarget", null);
    __publicField(this, "styleLTR", true);
    __publicField(this, "flushedState");
...
var cursorBlinkRate = GardState.Facet.define({
...
var dirCompartment = GardState.Compartment.define();
var _Wordgard = class _Wordgard {
  constructor(spec) {
    __publicField(this, "root", document);
    __publicField(this, "dom");
    __publicField(this, "scrollDOM");
    __publicField(this, "contentDOM");
    __publicField(this, "announceDOM");
    __publicField(this, "id", "wordgard-" + Math.floor(Math.random() * 16777215).toString(16));
    __publicField(this, "inputState");
    __publicField(this, "viewState");
    __publicField(this, "docTile");
    __publicField(this, "plugins", []);
    __publicField(this, "pluginMap", /* @__PURE__ */ new Map());
    __publicField(this, "editorAttrs", Attributes.none);
    __publicField(this, "contentAttrs", Attributes.none);
    __publicField(this, "styleModules");
    __publicField(this, "connected", false);
    __publicField(this, "flushing", 0);
    __publicField(this, "willFlush", false);
    __publicField(this, "flushFunc");
    __publicField(this, "lastFlush", Date.now());
    __publicField(this, "autoColorScheme", "light");
    __publicField(this, "observer");
    __publicField(this, "domReaders", []);
    __publicField(this, "domWriters", []);
    __publicField(this, "pendingTransactionListeners", /* @__PURE__ */ new Map());
    this.flushFunc = () => {
      if (this.willFlush)
        this.flush();
    };
  ...
  scrollTo(target) {
    ...
    if (from != to) {
      ...
      let left = Math.min(rect.left, other.left), top2 = Math.min(rect.top, other.top);
      rect = new DOMRect(left, top2, Math.max(rect.right, other.right) - left, Math.max(rect.bottom, other.bottom) - top2);
    }
  ...
  runUpdate(update, domChanges) {
    ...
    if (((composition == null ? void 0 : composition.wrapCursor) || !composition && (prevDocTile != this.docTile || update.selectionSet)) && this.hasFocus)
  ...
  get hasFocus() {
    var _a;
    return (this.dom.ownerDocument.hasFocus() || browser.safari && ((_a = this.inputState) == null ? void 0 : _a.lastContextMenu) > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
  }
  focus() {
    if (this.connected)
...
__publicField(_Wordgard, "clipboardOutputFilter", clipboardOutputFilter);
__publicField(_Wordgard, "clipboardOutputHTMLFilter", clipboardOutputHTMLFilter);
__publicField(_Wordgard, "clipboardTextSerializer", clipboardTextSerializer);
__publicField(_Wordgard, "clipboardOutputTextFilter", clipboardOutputTextFilter);
__publicField(_Wordgard, "clipboardInputFilter", clipboardInputFilter);
__publicField(_Wordgard, "clipboardInputHTMLFilter", clipboardInputHTMLFilter);
__publicField(_Wordgard, "clipboardTextParser", clipboardTextParser);
__publicField(_Wordgard, "clipboardInputTextFilter", clipboardInputTextFilter);
__publicField(_Wordgard, "pasteHandler", pasteHandler);
__publicField(_Wordgard, "dropHandler", dropHandler);
__publicField(_Wordgard, "isFocusChange", isFocusChange);
__publicField(_Wordgard, "styleModule", GardState.Facet.define());
__publicField(_Wordgard, "scrollHandler", GardState.Facet.define());
__publicField(_Wordgard, "exceptionSink", exceptionSink);
__publicField(_Wordgard, "transactionListener", GardState.Facet.define());
__publicField(_Wordgard, "updateListener", GardState.Facet.define());
__publicField(_Wordgard, "editable", GardState.Facet.define({ combine: (values) => values.length ? values[0] : true }));
__publicField(_Wordgard, "cursorBlinkRate", cursorBlinkRate);
__publicField(_Wordgard, "mouseSelectionStyle", mouseSelectionStyle);
__publicField(_Wordgard, "dragMovesSelection", dragBehavior);
__publicField(_Wordgard, "colorScheme", colorScheme);
__publicField(_Wordgard, "cspNonce", GardState.Facet.define({ combine: (values) => values.length ? values[0] : "" }));
__publicField(_Wordgard, "contentAttributes", GardState.Facet.define());
__publicField(_Wordgard, "editorAttributes", GardState.Facet.define());
__publicField(_Wordgard, "announce", Transaction.Effect.define());
__publicField(_Wordgard, "DocTile", DocTile);
__publicField(_Wordgard, "coveredMargins", GardState.Facet.define());
var Wordgard = _Wordgard;
...
Wordgard = function(Wordgard2) {
  ...
  class Update {
    constructor(editor, startState, state, transactions, flags) {
...
var editorPlugin = GardState.Facet.define();
var cursorPlugin = Wordgard.Plugin.fromClass(cursorLayer);
var PluginInstance = class {
  constructor(spec) {
    __publicField(this, "spec");
    __publicField(this, "mustUpdate", null);
    __publicField(this, "value", null);
    __publicField(this, "deactivated", false);
    this.spec = spec;
  }
  update(wg) {
    if (!this.value) {
  ...
  docUpdate(wg) {
    var _a;
    if ((_a = this.value) == null ? void 0 : _a.docUpdate) {
      try {
  ...
  connect(wg) {
    var _a;
    if ((_a = this.value) == null ? void 0 : _a.connect) {
      try {
  ...
  disconnect(wg) {
    var _a;
    if (!((_a = this.value) == null ? void 0 : _a.disconnect))
      return;
    try {
      this.value.disconnect(wg);
    } catch (e) {
  ...
  remove(wg) {
    ...
    if (wg.connected)
      this.disconnect(wg);
    if ((_a = this.value) == null ? void 0 : _a.remove)
      try {
  ...
  deactivate(remove) {
    var _a;
    if (remove && ((_a = this.value) == null ? void 0 : _a.remove))
      try {
...
var panelConfig = GardState.Facet.define({
  combine(configs) {
...
var panelPlugin = Wordgard.Plugin.fromClass(class {
  constructor(wg) {
  ...
  connect(wg) {
    var _a;
    for (let p of this.panels)
      (_a = p.connect) == null ? void 0 : _a.call(p, wg);
  }
  disconnect(wg) {
    var _a;
    for (let p of this.panels)
      (_a = p.disconnect) == null ? void 0 : _a.call(p, wg);
  }
  remove(wg) {
    this.top.sync([], wg);
    this.bottom.sync([], wg);
  ...
  sync(panels, wg) {
    ...
    for (let p of this.panels)
      if (!panels.includes(p)) {
        if (wg.connected)
          (_a = p.disconnect) == null ? void 0 : _a.call(p, wg);
        (_b = p.remove) == null ? void 0 : _b.call(p, wg);
      }
    this.panels = panels;
    this.syncDOM();
  }
...
var nextID = 0;
function id(prefix) {
  return prefix + "-" + (nextID++ % 16777215).toString(16);
}
...
var BarControl = class {
  constructor(item, wg, done) {
    __publicField(this, "item");
    __publicField(this, "dom");
    __publicField(this, "focusDOM");
    __publicField(this, "flags", 0);
    __publicField(this, "index", 0);
    this.item = item;
...
var BarSubmenu = class {
  constructor(item, children, wg) {
    ...
    __publicField(this, "flags", 0);
    __publicField(this, "activeChild", -3);
    __publicField(this, "index", 0);
    __publicField(this, "children");
    this.item = item;
...
var MenuBar = class _MenuBar {
  constructor(wg) {
    __publicField(this, "wg");
    __publicField(this, "dom");
    __publicField(this, "focusTimeout", -1);
  ...
  update(update) {
    ...
    if (items != this.items || update.startState.facet(barTemplate) != update.state.facet(barTemplate) || update.startState.textLTR != update.state.textLTR || PhraseSet.didChange(update.startState, update.state)) {
      this.items = items;
  ...
  updateElts(update, selection) {
    ...
    for (let i = 0; i < this.elts.length; i++) {
      ...
      if (update && (update === true || (elt.item.updateFor ? update.transactions.some((tr) => elt.item.updateFor(tr)) : changed))) {
        flags = ((elt.item.select ? elt.item.select(state) : true) ? 0 : 32) | ((elt.item.enable ? elt.item.enable(state) : true) ? 0 : 8) | ((elt.item instanceof Menu.Button && elt.item.active ? elt.item.active(state) : false) ? 16 : 0);
      } else {
...
var menuBarPanel = (() => Panel.show.of(MenuBar.create))();
...
var barTemplate = GardState.Facet.define({
...
var dialogField = GardState.Field.define({
  create() {
    return [];
  },
  update(dialogs, tr) {
...
var openDialogEffect = Transaction.Effect.define();
var closeDialogEffect = Transaction.Effect.define();
...
var TooltipViewManager = class {
  constructor(wg, facet, createTooltipView, removeTooltipView) {
    ...
    __publicField(this, "createTooltipView");
    __publicField(this, "removeTooltipView");
    __publicField(this, "input");
    __publicField(this, "tooltips");
    __publicField(this, "tooltipViews");
    this.facet = facet;
    ...
    for (let t of this.tooltipViews)
      if (tooltipViews.indexOf(t) < 0) {
        ...
        if (update.editor.connected)
          (_a = t.disconnect) == null ? void 0 : _a.call(t, update.editor);
        (_b = t.remove) == null ? void 0 : _b.call(t, update.editor);
      }
    if (above) {
...
var tooltipConfig = GardState.Facet.define({
  combine: (values) => {
    var _a, _b, _c;
    return {
      position: browser.ios ? "absolute" : ((_a = values.find((conf) => conf.position)) == null ? void 0 : _a.position) || "fixed",
      parent: ((_b = values.find((conf) => conf.parent)) == null ? void 0 : _b.parent) || null,
      tooltipSpace: ((_c = values.find((conf) => conf.tooltipSpace)) == null ? void 0 : _c.tooltipSpace) || ((wg) => windowRect(wg.win))
    };
  }
});
var knownHeight = /* @__PURE__ */ (() => /* @__PURE__ */ new WeakMap())();
var tooltipPlugin = Wordgard.Plugin.fromClass(class {
  constructor(wg) {
    __publicField(this, "wg");
    __publicField(this, "manager");
    __publicField(this, "above", []);
    __publicField(this, "inView", true);
    __publicField(this, "position");
    __publicField(this, "madeAbsolute", false);
    __publicField(this, "parent");
    __publicField(this, "classes");
    __publicField(this, "intersectionObserver");
    __publicField(this, "resizeObserver");
    __publicField(this, "lastTransaction", 0);
    __publicField(this, "measureTimeout", -1);
    this.wg = wg;
  ...
  createTooltip(tooltip, prev) {
    ...
    if (this.wg.connected)
      (_a = tooltipView.connect) == null ? void 0 : _a.call(tooltipView, this.wg);
  ...
  connect(wg) {
    ...
    for (let t of this.manager.tooltipViews) {
      (_a = t.connect) == null ? void 0 : _a.call(t, wg);
      if (this.resizeObserver)
  ...
  disconnect(wg) {
    ...
    for (let t of this.manager.tooltipViews) {
      (_a = t.disconnect) == null ? void 0 : _a.call(t, wg);
      if (this.resizeObserver)
        this.resizeObserver.unobserve(t.dom);
    }
  ...
  remove() {
    ...
    for (let tooltipView of this.manager.tooltipViews) {
      ...
      if (this.wg.connected)
        (_a = tooltipView.disconnect) == null ? void 0 : _a.call(tooltipView, this.wg);
      (_b = tooltipView.remove) == null ? void 0 : _b.call(tooltipView, this.wg);
    }
    if (this.parent)
      this.container.remove();
...
var closeHoverTooltipEffect = Transaction.Effect.define();
...
var showHoverTooltip = GardState.Facet.define({
...
var HoverTooltipHost = class _HoverTooltipHost {
  ...
  remove(wg) {
    var _a;
    for (let t of this.manager.tooltipViews)
      (_a = t.remove) == null ? void 0 : _a.call(t, wg);
  }
  passProp(name) {
    let value = void 0;
...
var showHoverTooltipHost = Tooltip.show.compute((state) => {
...
var HoverPlugin = class {
  constructor(wg, source, field, setHover, hoverTime) {
    ...
    __publicField(this, "setHover");
    __publicField(this, "hoverTime");
    __publicField(this, "lastMove");
    __publicField(this, "hoverTimeout", -1);
    __publicField(this, "restartTimeout", -1);
  ...
  mousemove(event) {
    ...
    if (active.length && tooltip && !isInTooltip(tooltip.dom, event) || this.pending) {
      let { pos } = active[0] || this.pending, end = ((_a = active[0]) == null ? void 0 : _a.end) ?? pos;
...
var inputRule = GardState.Facet.define();
var appender = Transaction.appender.of(applyInputRules);
...
var placeholderWidget = Widget.define({
  render(value) {
...
var placeholderShape = GardState.Facet.define();
...
var placeholderField = GardState.Field.define({
  create(state) {
...
var setDropCursorPos = Transaction.Effect.define({
  map(pos, mapping) {
    return pos == null ? null : { pos: mapping.mapPos(pos.pos), side: pos.side };
  }
});
var dropCursorPos = GardState.Field.define({
  create() {
    return null;
  },
  update(pos, tr) {
...
var drawDropCursor = Wordgard.Plugin.fromClass(class {
  constructor() {
  ...
  update(update) {
    var _a;
    let cursorPos2 = update.state.field(dropCursorPos);
    if (cursorPos2) {
      if (!this.cursor)
        this.cursor = update.editor.scrollDOM.appendChild(document.createElement("wg-dropcursor"));
      if (update.startState.field(dropCursorPos) != cursorPos2 || update.docChanged || update.geometryChanged)
        update.editor.scheduleDOMRead(this.measure);
    } else if (this.cursor) {
      (_a = this.cursor) == null ? void 0 : _a.remove();
      this.cursor = null;
    }
  }
  measure(wg) {
...
//# sourceMappingURL=chunk-DG7YTA36.js.map
