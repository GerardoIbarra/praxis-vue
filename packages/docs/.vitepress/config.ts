    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Praxis Color Picker', link: '/components/base/px-color-input' },
          ...
          { text: 'Praxis Theme Switch', link: '/components/base/px-theme-switch' },
        ],
      },
      {
        text: 'Navigation',
        collapsed: false,
        items: [
          { text: 'Praxis Dropdown Menu', link: '/components/navigation/px-dropdown-menu' },
          { text: 'Praxis Stepper Header', link: '/components/navigation/px-stepper-header' },
          { text: 'Praxis Stepper', link: '/components/navigation/px-stepper' },
          { text: 'Praxis Tab', link: '/components/navigation/px-tabs' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Praxis Document Viewer', link: '/components/data-display/px-document-viewer' },
        ],
      },
      {
        text: 'Layout',
        collapsed: false,
        items: [
          { text: 'Praxis Card', link: '/components/layout/px-card' },
          { text: 'Praxis Header', link: '/components/layout/px-header' },
          { text: 'Praxis List Layout', link: '/components/layout/px-list-layout' },
          { text: 'Praxis Form Layout', link: '/components/layout/px-form-layout' },
          { text: 'Praxis Filter Bar', link: '/components/layout/px-filter-bar' },
        ],
      },
      {
        text: 'Primitives',
