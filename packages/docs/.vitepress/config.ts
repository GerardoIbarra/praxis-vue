  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: 'Avatar', link: '/components/base/ui-avatar' },
          { text: 'Label', link: '/components/base/ui-label' },
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: 'Accordion', link: '/components/primitives/ui-accordion' },
          { text: 'Badge', link: '/components/primitives/ui-badge' },
          { text: 'Checkbox', link: '/components/primitives/ui-checkbox' },
          { text: 'Dialog', link: '/components/primitives/ui-dialog' },
          { text: 'Drawer', link: '/components/primitives/ui-drawer' },
          { text: 'Radio Button', link: '/components/primitives/ui-radio-button' },
          { text: 'Timeline', link: '/components/primitives/ui-timeline' },
        ],
      },
    ],
