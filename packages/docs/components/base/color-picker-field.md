<script setup>
import { ref } from 'vue'
import ColorPickerField from '@praxis/ui-src/components/base/ColorPickerField.vue'
...
<ComponentDemo>
  <div style="width:280px">
    <ColorPickerField v-model="color1" label="Brand Color" />
...
<ComponentDemo title="Required">
  <div style="width:280px">
    <ColorPickerField v-model="color2" label="Primary Color" :required="true" />
  </div>
...
<ComponentDemo title="Disabled">
  <div style="width:280px">
    <ColorPickerField v-model="colorDisabled" label="Read-only Color" :disabled="true" />
  </div>
