<script setup>
import { ref } from 'vue'
import PraxisColorPickerField from '@praxis/ui-src/components/base/PraxisColorPickerField.vue'
...
<ComponentDemo>
  <div style="width:280px">
    <PraxisColorPickerField v-model="color1" label="Brand Color" />
...
<script setup>
import { ref } from 'vue'
import { PraxisColorPickerField } from 'praxis-vue-ui'
...
<ComponentDemo title="Required">
  <div style="width:280px">
    <PraxisColorPickerField v-model="color2" label="Primary Color" :required="true" />
  </div>
...
<ComponentDemo title="Disabled">
  <div style="width:280px">
    <PraxisColorPickerField v-model="colorDisabled" label="Read-only Color" :disabled="true" />
  </div>
