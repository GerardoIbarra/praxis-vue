<script setup>
import { ref } from 'vue'
import PraxisPdfViewer from '@praxis/ui-src/components/data-display/PraxisPdfViewer.vue'
...
```vue
<script setup>
import { PraxisPdfViewer } from 'praxis-vue-ui'
</script>

<template>
  <PraxisPdfViewer url="https://example.com/document.pdf" />
</template>
```
