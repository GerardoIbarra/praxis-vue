<script setup>
import { ref } from 'vue'
import PraxisWeekDaysSelector from '@praxis/ui-src/components/forms/PraxisWeekDaysSelector.vue'
...
<ComponentDemo>
  <div style="width:100%;max-width:500px">
    <PraxisWeekDaysSelector v-model="selectedDay" mode="radio" label="Recurrence Day" />
...
<script setup>
import { ref } from 'vue'
import { PraxisWeekDaysSelector } from 'praxis-vue-ui'

const day = ref('monday')
</script>

<template>
  <PraxisWeekDaysSelector v-model="day" mode="radio" label="Recurrence Day" />
  <p>Selected: {{ day }}</p>
</template>
```
...
<ComponentDemo title="Checkbox Mode">
  <div style="width:100%;max-width:500px">
    <PraxisWeekDaysSelector v-model="selectedDays" mode="checkbox" label="Working Days" />
    <p style="margin-top:0.75rem;font-size:0.85rem;color:var(--vp-c-text-2)">
