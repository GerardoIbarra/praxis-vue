<script setup>
import { ref } from 'vue'
import PraxisTabComponent from '@praxis/ui-src/components/navigation/PraxisTabComponent.vue'
...
<ComponentDemo>
  <div style="width:100%">
    <PraxisTabComponent v-model="activeTab" :tabs="tabs" />
...
<script setup>
import { ref } from 'vue'
import { PraxisTabComponent } from 'praxis-vue-ui'
