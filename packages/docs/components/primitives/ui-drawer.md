<script setup>
import { ref } from 'vue'
import UiDrawer from '@praxis/ui-src/components/_primitives/UiDrawer.vue'
...
<ComponentDemo>
  ...
  <ClientOnly>
    <UiDrawer v-model:visible="open" header="Details" :position="position">
...
<script setup>
import { ref } from 'vue'
import { UiDrawer } from 'praxis-vue-ui'
