<template>
  <div class="praxis-theme-toggle-container flex items-center justify-center">
    <input
      id="theme-checkbox"
      type="checkbox"
    ...
    <label for="theme-checkbox" class="theme-label">
      ...
      <div
        class="praxis-theme-toggle"
        :class="{ 'praxis-theme-toggle-checked': modelValue }"
      ></div>
    </label>
  </div>
</template>
